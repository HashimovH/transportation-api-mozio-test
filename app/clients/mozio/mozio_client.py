...
from app.clients.mozio.schemas.search import (
    PollSearchResponse,
...
class MozioClient(TransporationClient):
    ...
    def _make_request(
        self, method: HTTPMethod, url: str, data=None
    ) -> requests.Response:
        headers = {
            "API-KEY": f"{self.access_token}",
            ...
            converted_results.append(
                {
                    ...
                    "vehicle": {
                        ...
                        "vehicle_type": result.steps[
                            0
                        ].details.vehicle.vehicle_type.get("name"),
                        "max_bags": result.steps[0].details.vehicle.max_bags,
                        "max_bags_for_each_passenger": result.steps[
                            0
                        ].details.vehicle.is_max_bags_per_person,
                        "max_passengers": result.steps[
                            0
                        ].details.vehicle.max_passengers,
                        "category": result.steps[0].details.vehicle.category.get(
                            "name"
                        ),
                        ...
                        "vehicle_class": result.steps[
                            0
                        ].details.vehicle.vehicle_class_detail.get("display_name"),
                    },
                    ...
                    "provider": {
                        ...
                        "rating_with_decimal": result.steps[
                            0
                        ].details.provider.rating_with_decimals,
                    },
                    "can_cancel_online": result.steps[
                        0
                    ].details.cancellation.cancellable_online,
                    "can_cancel_offline": result.steps[
                        0
                    ].details.cancellation.cancellable_offline,
                    "can_amend": result.steps[0].details.cancellation.amendable,
                    "cancel_notice": result.steps[0]
                    .details.cancellation.policy[0]
                    .get("notice"),
                    "cancel_refund_percent": result.steps[0]
                    .details.cancellation.policy[0]
                    .get("refund_percent"),
                    "departure_time": result.steps[0].details.departure_datetime,
                    "wait_time_minutes": result.steps[0].details.wait_time.get(
                        "minutes_included"
                    ),
                    "amenities": result.steps[0].details.amenities,
                    "alternative_departure_time": result.steps[0]
                    .details.alternative_times.get("options")[0]
                    .get("departure_datetime"),
                    "alternative_arrival_time": result.steps[0]
                    .details.alternative_times.get("options")[0]
